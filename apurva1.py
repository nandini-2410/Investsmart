...
def options(data, category):
    """Filter the data based on the category."""
    return data[data['category'] == category] 

def calculate(data, amount, age, selected_funds):
    """Placeholder for the calculate function."""
    st.write("Calculating portfolio based on the following parameters:")
    st.write(f"Amount: {amount}, Age: {age}, Selected Funds: {selected_funds}")
...
def main():
    ...
    amount = st.text_input("Enter Amount you wish to Invest:", key='amount_input')
